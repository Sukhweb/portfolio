  ...
  return (
    ...
    <section className={style.resume}>
      ...
      <div className={style.content}>
        <h2 className={`mt-5 mb-5 ${style.profileHeader}`}>Professional Profile</h2>
        ...
        <h2 className={style.profileHeader}>Interpersonal Skills</h2>
        <p className="container mt-5 mb-5">
        ...
        <h2 className={style.profileHeader}>Work Experience</h2>
